...
export default function OtpStep({ otp, setOtp, onSubmit, expiresIn, onExpired }: Props) {
  ...
  return (
    <>
      <p className="text-[11pt] text-center text-[#333] mt-[5px] mb-[5px]">Verification</p>
      <input
        type="text"
        value={otp}
      ...
      />
      <p className="text-[9pt] text-center text-[#333] mt-[2px] mb-0">OTP</p>
      <p className="text-[9pt] text-center text-gray-400 mt-[2px]">
