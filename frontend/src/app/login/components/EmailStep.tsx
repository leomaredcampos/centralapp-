  ...
  return (
    <>
      ...
      <input
        ...
        autoFocus
        className="w-[350px] p-[2px] border-[0.25px] border-black outline-none text-center disabled:opacity-50"
      />
      <p className="text-center text-black mt-[2px] mb-0">Email Address</p>
      {countdown > 0 ? (
        <p className="text-center text-red-500 mt-[10px]">
