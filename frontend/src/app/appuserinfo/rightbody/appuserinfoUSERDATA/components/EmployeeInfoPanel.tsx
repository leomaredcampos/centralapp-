...
const lbl = "text-black leading-none text-[clamp(10pt,0.78vw,16px)]";
const inp = "w-full p-[1px] border-[0.25px] border-black outline-none text-[clamp(10pt,0.78vw,16px)]";
  ...
  return (
    <div className="w-full min-w-0 h-full flex flex-col overflow-hidden">
      <div className="flex-shrink-0 px-[6px] py-[1px] border-b-[0.25px] border-black bg-gray-50">
        <span className="text-black text-[clamp(10pt,0.78vw,16px)]">Employee Information</span>
      </div>
          ...
          <div className="grid" style={{ gridTemplateColumns: "59% 40%", gap: "1%" }}>
            ...
            <div>
              ...
              <label className="flex items-center gap-[2px] border-[0.25px] border-black p-[0px] cursor-pointer w-full">
                <span className="text-blue-600 border-b-[0.25px] border-blue-600 whitespace-nowrap text-[clamp(10pt,0.78vw,16px)]">Choose file</span>
