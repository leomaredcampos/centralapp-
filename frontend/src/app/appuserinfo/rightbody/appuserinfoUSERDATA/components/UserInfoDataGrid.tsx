  ...
  return (
    <div className="flex flex-col border border-gray-200 rounded-lg shadow-sm bg-white" style={{ height: "100%", overflow: "hidden" }}>
      <div className="flex-shrink-0 px-[6px] py-[2px] border-b border-gray-200 bg-gray-50 flex flex-wrap items-center gap-[4px]">
        <input placeholder="Type to search..." className="p-[1px] border border-gray-300 outline-none" style={{ width: "25.5%" }} />
        ...
        <input placeholder="Select modules..." className="p-[1px] border border-gray-300 outline-none" style={{ width: "18.3%" }} />
        ...
        <table style={{ borderCollapse: "collapse", tableLayout: "fixed", width: "100%" }}>
          <thead className="sticky top-0 bg-gray-50 z-10">
            <tr className="border-b border-gray-200">
              <th className="px-[6px] py-[3px] text-gray-500 font-normal bg-gray-50" style={{ width: "2.2%", position: "sticky", left: 0, zIndex: 20 }}>
                <input type="checkbox" />
              </th>
              <th className="text-left px-[6px] py-[3px] text-gray-500 font-normal bg-gray-50" style={{ width: "29.1%", position: "sticky", left: "2.2%", zIndex: 20 }}>Employee Email Address</th>
              <th className="text-left px-[6px] py-[3px] text-gray-500 font-normal bg-gray-50" style={{ width: "9.1%", position: "sticky", left: "31.3%", zIndex: 20 }}>Account Status</th>
              <th className="text-left px-[6px] py-[3px] text-gray-500 font-normal bg-gray-50" style={{ width: "13.6%" }}>As Date of</th>
              <th className="text-left px-[6px] py-[3px] text-gray-500 font-normal bg-gray-50" style={{ width: "13.6%" }}>Expiration Date</th>
              <th className="text-left px-[6px] py-[3px] text-gray-500 font-normal bg-gray-50" style={{ width: "31.8%" }}>Written By</th>
            </tr>
          </thead>
          <tbody>
            {users.map((u, i) => (
