...
export default function UserInfoDataGrid({ users, onPrev, onNext }: Props) {
  ...
  return (
    <div className="flex flex-col border-[0.25px] border-black 200 rounded-lg shadow-sm bg-white" style={{ height: "100%", overflow: "hidden" }}>
      <div className="flex-shrink-0 px-[6px] py-[2px] border-b-[0.25px] border-black 200 bg-gray-50 flex flex-wrap items-center gap-[4px]">
        <input placeholder="Type to search..." className="p-[1px] border-[0.25px] border-black 300 outline-none" style={{ width: "25.5%" }} />
        ...
        <input placeholder="Select modules..." className="p-[1px] border-[0.25px] border-black 300 outline-none" style={{ width: "18.3%" }} />
      ...
      <div style={{ flex: 1, overflow: "auto", scrollbarWidth: "thin", scrollbarColor: "#d1d5db transparent", position: "relative" }}>
        <table style={{ borderCollapse: "collapse", tableLayout: "fixed", width: "100%" }}>
          <thead className="sticky top-0 bg-gray-50 z-10">
            <tr className="border-b-[0.25px] border-black 200">
          ...
          <tbody>
            {users.map((u, i) => (
              <tr key={i} className="border-b-[0.25px] border-black 100 hover:bg-gray-50 cursor-pointer">
