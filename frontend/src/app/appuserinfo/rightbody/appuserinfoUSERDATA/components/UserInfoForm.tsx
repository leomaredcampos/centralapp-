...
const inp = "w-full text-[clamp(9.5px,0.78vw,16px)] p-[1px] border-[0.25px] border-black outline-none";
const lbl = "text-[clamp(9.5px,0.78vw,16px)] text-black";
const req = <span className="text-red-500">*</span>;
const row4 = "grid grid-cols-4 gap-[4px] mb-[4px]";
const row2 = "grid grid-cols-2 gap-[4px] mb-[4px]";
const btnClass = "text-[clamp(9.5px,0.78vw,16px)] px-[12px] py-[1px] bg-white border-[0.25px] border-black cursor-pointer hover:bg-gray-50";
      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        ...
        <div className="flex-shrink-0 px-[10px] pt-[6px]">
          ...
          <div className="border-b-[0.25px] border-black pb-[2px] mb-[4px]">
            <span className="text-[clamp(9.5px,0.78vw,16px)] text-black">Company Information</span>
          </div>
        </div>
