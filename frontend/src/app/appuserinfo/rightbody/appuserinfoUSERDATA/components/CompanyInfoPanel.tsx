  ...
  return (
    <>
      <div className="flex-shrink-0 px-[6px] py-[1px] border-b-[0.25px] border-black 200 bg-gray-50">
        <span className="text-black 600 text-[clamp(8px,0.78vw,16px)]">Company Information</span>
      </div>
      <div className="flex-1 px-[6px] py-[1px] overflow-y-auto" style={{ scrollbarWidth: "thin" }}>
        ...
        <div className={row2}>
          <div>
            ...
            <label className="flex items-center gap-[3px] border-[0.25px] border-black 300 p-[1px] cursor-pointer w-full">
