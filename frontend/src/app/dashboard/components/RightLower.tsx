...
export default function RightLower({ show2FA, apps, activeApp, onAppClick, userInfoRef }: Props) {
  if (show2FA) return (
    <div className="h-[93%] border-[0.25px] border-black bg-gradient-to-br from-white via-gray-50 to-gray-100">
      <TwoFactorPage />
    </div>
  );
  if (activeApp === "userinfoapp") return (
    <div className="h-[93%] border-[0.25px] border-black p-[10px] flex bg-gradient-to-br from-white via-gray-50 to-gray-100">
