  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-[10px]">
      ...
      <button
        onClick={onVerify}
        disabled={loading}
        className="w-[350px] text-[9pt] p-[2px] leading-none bg-white border-t-[0.25px] border-b-[0.25px] border-black border-l-0 border-r-0 cursor-pointer hover:bg-[#f0f0f0] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        Verify
      </button>
    </div>
